...
const ACCT_KEYS: Record<string, keyof Balances> = {
  ...
  "Vanguard Brokerage": "brokerage", "Vanguard Roth IRA": "roth",
};
const ACCOUNTS = Object.keys(ACCT_KEYS);
const CASH_ACCOUNTS = ["Checking", "Savings"];

const EXPENSE_CATS = [
  "Food & Beverages","Alcohol","Bars & Entertainment","Coffee & Cafes",
  "Gas","Groceries","Shopping","Clothing","Amazon",
  "Vacation & Travel","Gym & Fitness","Subscriptions","Personal Care",
  "Venmo","Cash","Other",
];
...
const CATS: Record<string, string[]> = {
  income: INCOME_CATS, expense: EXPENSE_CATS,
  transfer: ["Account Transfer"], investment: INVEST_CATS,
};
...
const DEFAULT: State = {
  transactions: [{"id": 1, "date": "2026-05-31", "desc": "Opening balance", "type": "income", "category": "Other Income", "amount": 800.59, "fromAccount": "", "toAccount": "Checking"}, {"id": 2, "date": "2026-05-31", "desc": "Opening balance", "type": "income", "category": "Other Income", "amount": 90.61, "fromAccount": "", "toAccount": "Savings"}, {"id": 100, "date": "2026-06-01", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 20.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 101, "date": "2026-06-01", "desc": "PrizePicks", "type": "income", "category": "Other Income", "amount": 20.0, "fromAccount": "", "toAccount": "Checking"}, {"id": 102, "date": "2026-06-01", "desc": "The Loudoun Kitchen & Bar", "type": "expense", "category": "Bars & Entertainment", "amount": 16.78, "fromAccount": "Checking", "toAccount": ""}, {"id": 103, "date": "2026-06-01", "desc": "Sheetz", "type": "expense", "category": "Gas", "amount": 11.81, "fromAccount": "Checking", "toAccount": ""}, {"id": 104, "date": "2026-06-01", "desc": "CACI Paycheck", "type": "income", "category": "CACI", "amount": 1520.22, "fromAccount": "", "toAccount": "Savings"}, {"id": 200, "date": "2026-06-02", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 25.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 300, "date": "2026-06-03", "desc": "VENMO", "type": "income", "category": "Venmo", "amount": 81.96, "fromAccount": "", "toAccount": "Checking"}, {"id": 301, "date": "2026-06-03", "desc": "FD Sptsbk Casino", "type": "expense", "category": "Bars & Entertainment", "amount": 20.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 400, "date": "2026-06-04", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 20.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 500, "date": "2026-06-05", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 30.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 501, "date": "2026-06-05", "desc": "FD Sptsbk Casino", "type": "income", "category": "Other Income", "amount": 10.0, "fromAccount": "", "toAccount": "Checking"}, {"id": 502, "date": "2026-06-05", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 100.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 503, "date": "2026-06-05", "desc": "ATM Withdrawal", "type": "expense", "category": "Cash", "amount": 209.49, "fromAccount": "Checking", "toAccount": ""}, {"id": 504, "date": "2026-06-05", "desc": "Raising Cane's", "type": "expense", "category": "Food & Beverages", "amount": 13.03, "fromAccount": "Checking", "toAccount": ""}, {"id": 505, "date": "2026-06-05", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 100.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 600, "date": "2026-06-06", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 100.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 601, "date": "2026-06-06", "desc": "Virginia ABC", "type": "expense", "category": "Alcohol", "amount": 11.65, "fromAccount": "Checking", "toAccount": ""}, {"id": 602, "date": "2026-06-06", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 200.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 700, "date": "2026-06-07", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 300.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 701, "date": "2026-06-07", "desc": "NH F B Walk Up Bar", "type": "expense", "category": "Bars & Entertainment", "amount": 5.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 702, "date": "2026-06-07", "desc": "Chipotle", "type": "expense", "category": "Food & Beverages", "amount": 23.11, "fromAccount": "Checking", "toAccount": ""}, {"id": 800, "date": "2026-06-08", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 6.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 801, "date": "2026-06-08", "desc": "Wawa", "type": "expense", "category": "Food & Beverages", "amount": 6.84, "fromAccount": "Checking", "toAccount": ""}, {"id": 802, "date": "2026-06-08", "desc": "Wegmans", "type": "expense", "category": "Groceries", "amount": 21.19, "fromAccount": "Checking", "toAccount": ""}, {"id": 803, "date": "2026-06-08", "desc": "Spider Kelly's", "type": "expense", "category": "Bars & Entertainment", "amount": 8.22, "fromAccount": "Checking", "toAccount": ""}, {"id": 804, "date": "2026-06-08", "desc": "Spider Kelly's", "type": "expense", "category": "Bars & Entertainment", "amount": 33.64, "fromAccount": "Checking", "toAccount": ""}, {"id": 805, "date": "2026-06-08", "desc": "TST The Ballroom", "type": "expense", "category": "Bars & Entertainment", "amount": 17.02, "fromAccount": "Checking", "toAccount": ""}, {"id": 806, "date": "2026-06-08", "desc": "TST The Ballroom", "type": "expense", "category": "Bars & Entertainment", "amount": 27.75, "fromAccount": "Checking", "toAccount": ""}, {"id": 807, "date": "2026-06-08", "desc": "TST The Ballroom", "type": "expense", "category": "Bars & Entertainment", "amount": 26.87, "fromAccount": "Checking", "toAccount": ""}, {"id": 900, "date": "2026-06-09", "desc": "Sheetz", "type": "expense", "category": "Gas", "amount": 18.53, "fromAccount": "Checking", "toAccount": ""}, {"id": 901, "date": "2026-06-09", "desc": "Chipotle", "type": "expense", "category": "Food & Beverages", "amount": 11.22, "fromAccount": "Checking", "toAccount": ""}, {"id": 1000, "date": "2026-06-10", "desc": "VENMO", "type": "income", "category": "Venmo", "amount": 5.0, "fromAccount": "", "toAccount": "Checking"}, {"id": 1001, "date": "2026-06-10", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 12.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 1100, "date": "2026-06-11", "desc": "County of Loudoun (Rec Center)", "type": "income", "category": "Rec Center", "amount": 312.56, "fromAccount": "", "toAccount": "Checking"}, {"id": 1101, "date": "2026-06-11", "desc": "Withdrawal to Savings", "type": "transfer", "category": "Account Transfer", "amount": 588.41, "fromAccount": "Checking", "toAccount": "Savings"}, {"id": 1400, "date": "2026-06-14", "desc": "GOFANTIX VHSL", "type": "expense", "category": "Bars & Entertainment", "amount": 23.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 1401, "date": "2026-06-14", "desc": "SQ Briar Woods Athletic", "type": "expense", "category": "Gym & Fitness", "amount": 4.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 1500, "date": "2026-06-15", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 36.62, "fromAccount": "Checking", "toAccount": ""}, {"id": 1501, "date": "2026-06-15", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 400.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 1600, "date": "2026-06-16", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 358.64, "fromAccount": "Checking", "toAccount": ""}, {"id": 1700, "date": "2026-06-17", "desc": "Deposit from Checking", "type": "transfer", "category": "Account Transfer", "amount": 20.0, "fromAccount": "Checking", "toAccount": "Savings"}, {"id": 1800, "date": "2026-06-18", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 20.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 1801, "date": "2026-06-18", "desc": "SweetFrog", "type": "expense", "category": "Food & Beverages", "amount": 6.61, "fromAccount": "Checking", "toAccount": ""}, {"id": 1900, "date": "2026-06-19", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 100.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 2000, "date": "2026-06-20", "desc": "SQ CloudFizz", "type": "expense", "category": "Food & Beverages", "amount": 16.1, "fromAccount": "Checking", "toAccount": ""}, {"id": 2001, "date": "2026-06-20", "desc": "TST My Big Cheese Pizza", "type": "expense", "category": "Food & Beverages", "amount": 25.5, "fromAccount": "Checking", "toAccount": ""}, {"id": 2002, "date": "2026-06-20", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 200.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 2200, "date": "2026-06-22", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 20.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 2201, "date": "2026-06-22", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 20.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 2202, "date": "2026-06-22", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 40.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 2203, "date": "2026-06-22", "desc": "Chef Lee", "type": "expense", "category": "Food & Beverages", "amount": 14.12, "fromAccount": "Checking", "toAccount": ""}, {"id": 2204, "date": "2026-06-22", "desc": "Tropical Smoothie Cafe", "type": "expense", "category": "Food & Beverages", "amount": 7.62, "fromAccount": "Checking", "toAccount": ""}, {"id": 2205, "date": "2026-06-22", "desc": "CACI Paycheck", "type": "income", "category": "CACI", "amount": 1809.62, "fromAccount": "", "toAccount": "Savings"}, {"id": 2300, "date": "2026-06-23", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 20.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 2301, "date": "2026-06-23", "desc": "VENMO", "type": "income", "category": "Venmo", "amount": 22.0, "fromAccount": "", "toAccount": "Checking"}, {"id": 2302, "date": "2026-06-23", "desc": "Deposit from Savings", "type": "transfer", "category": "Account Transfer", "amount": 200.0, "fromAccount": "Savings", "toAccount": "Checking"}, {"id": 2303, "date": "2026-06-23", "desc": "Shell Oil", "type": "expense", "category": "Gas", "amount": 5.43, "fromAccount": "Checking", "toAccount": ""}, {"id": 2400, "date": "2026-06-24", "desc": "VENMO", "type": "income", "category": "Venmo", "amount": 15.0, "fromAccount": "", "toAccount": "Checking"}, {"id": 2401, "date": "2026-06-24", "desc": "VENMO", "type": "income", "category": "Venmo", "amount": 50.27, "fromAccount": "", "toAccount": "Checking"}, {"id": 2402, "date": "2026-06-24", "desc": "FRG MLB Shop", "type": "expense", "category": "Shopping", "amount": 146.1, "fromAccount": "Checking", "toAccount": ""}, {"id": 2403, "date": "2026-06-24", "desc": "Virginia ABC", "type": "expense", "category": "Alcohol", "amount": 13.77, "fromAccount": "Checking", "toAccount": ""}, {"id": 2404, "date": "2026-06-24", "desc": "Vanguard Buy", "type": "investment", "category": "Vanguard Brokerage", "amount": 1000.0, "fromAccount": "Savings", "toAccount": "Vanguard Brokerage"}, {"id": 2500, "date": "2026-06-25", "desc": "County of Loudoun (Rec Center)", "type": "income", "category": "Rec Center", "amount": 321.04, "fromAccount": "", "toAccount": "Checking"}, {"id": 2501, "date": "2026-06-25", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 20.0, "fromAccount": "Checking", "toAccount": ""}, {"id": 2502, "date": "2026-06-25", "desc": "VENMO", "type": "expense", "category": "Venmo", "amount": 43.47, "fromAccount": "Checking", "toAccount": ""}, {"id": 2503, "date": "2026-06-25", "desc": "VENMO", "type": "income", "category": "Venmo", "amount": 41.44, "fromAccount": "", "toAccount": "Checking"}, {"id": 2504, "date": "2026-06-25", "desc": "VENMO", "type": "income", "category": "Venmo", "amount": 86.94, "fromAccount": "", "toAccount": "Checking"}, {"id": 2505, "date": "2026-06-25", "desc": "Withdrawal to Savings", "type": "transfer", "category": "Account Transfer", "amount": 419.14, "fromAccount": "Checking", "toAccount": "Savings"}, {"id": 9998, "date": "2026-06-25", "desc": "Wegmans (Pending)", "type": "expense", "category": "Groceries", "amount": 40.26, "fromAccount": "Checking", "toAccount": ""}, {"id": 9997, "date": "2026-06-25", "desc": "Rita's (Pending)", "type": "expense", "category": "Food & Beverages", "amount": 10.76, "fromAccount": "Checking", "toAccount": ""}, {"id": 9996, "date": "2026-06-25", "desc": "Moe's Southwest Grill (Pending)", "type": "expense", "category": "Food & Beverages", "amount": 15.55, "fromAccount": "Checking", "toAccount": ""}, {"id": 9995, "date": "2026-06-25", "desc": "VENMO (Pending)", "type": "expense", "category": "Venmo", "amount": 10.0, "fromAccount": "Checking", "toAccount": ""}],
  balances: {"checking": 200.0, "savings": 2427.98, "brokerage": 6464.35, "roth": 16771.44},
};
...
function applyTx(bal:Balances, tx:Transaction, reverse=false):Balances {
  const b={...bal}, s=reverse?-1:1;
  const from=ACCT_KEYS[tx.fromAccount], to=ACCT_KEYS[tx.toAccount];
...
const WEEKLY_PLAN=[
  ...
  {day:"Friday",focus:"OFF 🎉",color:C.dim,time:"Evening off",
   tasks:["Social time — non-negotiable","BFN events / going out","No studying"],links:[]},
  {day:"Saturday",focus:"OFF 🎉",color:C.dim,time:"All day off",
   tasks:["Full rest and recharge","Social time with friends","Consistency beats burnout"],links:[]},
...
// ── Top-level components (defined OUTSIDE Dashboard to prevent remount on state change) ──

function CatPills({cats, selected, color, onSelect}:{cats:string[];selected:string;color:string;onSelect:(c:string)=>void}){
  return(
    <div style={{display:"flex",flexWrap:"wrap",gap:5}}>
      {cats.map(c=>(
        <button key={c} onClick={()=>onSelect(c)}
          style={{padding:"4px 10px",borderRadius:99,border:`1px solid ${selected===c?color:C.border}`,background:selected===c?`${color}22`:"transparent",color:selected===c?color:C.muted,fontSize:11,cursor:"pointer",fontWeight:selected===c?700:400}}>
          {CAT_EMOJI[c]} {c}
        </button>
      ))}
    </div>
...
function AcctPills({accounts, selected, color, onSelect}:{accounts:string[];selected:string;color:string;onSelect:(a:string)=>void}){
  return(
    <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
      {accounts.map(a=>(
        <button key={a} onClick={()=>onSelect(a)}
          style={{padding:"5px 12px",borderRadius:7,border:`1px solid ${selected===a?color:C.border}`,background:selected===a?`${color}22`:"transparent",color:selected===a?color:C.muted,fontSize:12,cursor:"pointer",fontWeight:selected===a?700:400}}>
          {a}
        </button>
      ))}
    </div>
...
export default function Dashboard(){
  ...
  function startEdit(t:Transaction){
    setEditId(t.id);setEditDesc(t.desc);setEditAmt(String(t.amount));
    setEditCat(t.category);setEditFrom(t.fromAccount);setEditTo(t.toAccount);
  }

  function saveEdit(id:number){
    const old=state.transactions.find(t=>t.id===id);
    if(!old)return;
    const updated:Transaction={...old,desc:editDesc,amount:parseFloat(parseFloat(editAmt).toFixed(2)),category:editCat,fromAccount:editFrom,toAccount:editTo};
  ...
  const filtered=allSorted.filter(t=>filterType==="All"||t.type===filterType);
      ...
      <div style={{maxWidth:980,margin:"0 auto",padding:"16px"}}>
        ...
        {mainTab==="calendar"&&(
          <div style={{display:"grid",gridTemplateColumns:selectedDay?"1fr 340px":"1fr",gap:14,alignItems:"start"}}>
            ...
            {/* Day panel — all state lives in Dashboard, no inner components */}
            {selectedDay&&(
              <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:16,position:"sticky",top:16}}>
                ...
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:5,marginBottom:14}}>
                  {(["expense","income","transfer","investment"] as const).map(t=>(
                    <button key={t} onClick={()=>changeType(t)}
                      ...
                      {t==="expense"?"− Exp":t==="income"?"+ Inc":t==="transfer"?"⇄ Xfer":"↑ Inv"}
                    </button>
                  ))}
                </div>

                {/* Description — stable input, no remount */}
                <div style={{marginBottom:8}}>
                  ...
                  <input
                    ...
                    placeholder={addType==="income"?"e.g. CACI paycheck":addType==="expense"?"e.g. Chipotle":addType==="transfer"?"e.g. Savings → Checking":"e.g. Vanguard contribution"}
                    style={inp}
                  />
                </div>
                ...
                {addType!=="transfer"&&(
                  <div style={{marginBottom:10}}>
                    ...
                    <CatPills cats={CATS[addType]} selected={cat} color={typeColor} onSelect={setCat}/>
                  </div>
                )}
                ...
                {addType!=="income"&&(
                  <div style={{marginBottom:10}}>
                    <span style={lbl}>Money leaves from</span>
                    <AcctPills
                      accounts={addType==="investment"?CASH_ACCOUNTS:ACCOUNTS}
                      selected={fromAcct} color={typeColor} onSelect={setFromAcct}
                    />
                  </div>
                )}
                {addType!=="expense"&&(
                  <div style={{marginBottom:12}}>
                    <span style={lbl}>Money goes into</span>
                    <AcctPills
                      accounts={addType==="investment"?INVEST_CATS:ACCOUNTS}
                      selected={toAcct} color={typeColor} onSelect={setToAcct}
                    />
                  </div>
                )}

                <button onClick={addTx} style={{width:"100%",padding:"10px",borderRadius:9,border:"none",background:typeColor,color:"#0d1117",fontWeight:700,fontSize:14,cursor:"pointer",marginBottom:4}}>
                  Add {addType}
                </button>

                {/* Logged transactions for this day */}
                {selTxs.length>0&&(
                      ...
                      <div key={t.id} style={{borderBottom:`1px solid ${C.border}`,paddingBottom:8,marginBottom:8}}>
                        {editId===t.id?(
                          <div style={{background:C.high,borderRadius:8,padding:10}}>
                            <input value={editDesc} onChange={e=>setEditDesc(e.target.value)} style={{...inp,marginBottom:6}} placeholder="Description"/>
                            <input type="number" value={editAmt} onChange={e=>setEditAmt(e.target.value)} style={{...inp,marginBottom:6}} placeholder="Amount"/>
                            <select value={editCat} onChange={e=>setEditCat(e.target.value)} style={{...inp,marginBottom:6}}>
                              {CATS[t.type].map(c=><option key={c}>{c}</option>)}
                            </select>
                            {t.type!=="income"&&<select value={editFrom} onChange={e=>setEditFrom(e.target.value)} style={{...inp,marginBottom:6}}>
                              {ACCOUNTS.map(a=><option key={a}>{a}</option>)}
                            </select>}
                            {t.type!=="expense"&&<select value={editTo} onChange={e=>setEditTo(e.target.value)} style={{...inp,marginBottom:8}}>
                              {ACCOUNTS.map(a=><option key={a}>{a}</option>)}
                            </select>}
                          ...
                          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                            <div>
                              <span style={{fontWeight:600,fontSize:13,color:txColor(t)}}>{t.type==="income"?"+":"-"}{fmt(t.amount)}</span>
                            ...
                            <div style={{display:"flex",gap:6}}>
                              ...
                              <button onClick={()=>deleteTx(t.id)} style={{background:"transparent",border:"none",color:C.dim,cursor:"pointer",fontSize:16}}>✕</button>
                            </div>
                          </div>
                        )}
                      </div>
            ...
            <div style={{display:"flex",gap:6,marginBottom:12,flexWrap:"wrap"}}>
              {["All","income","expense","transfer","investment"].map(f=>(
                <button key={f} onClick={()=>setFilterType(f)}
                  style={{padding:"5px 12px",borderRadius:7,border:`1px solid ${filterType===f?C.teal:C.border}`,background:filterType===f?`${C.teal}22`:"transparent",color:filterType===f?C.teal:C.muted,fontSize:12,cursor:"pointer",fontWeight:filterType===f?700:400,textTransform:"capitalize"}}>
                  {f}
                </button>
              ))}
            </div>
            <div style={{background:C.surface,border:`1px solid ${C.border}`,borderRadius:12,padding:16}}>
              <div style={{color:C.muted,fontSize:11,textTransform:"uppercase",letterSpacing:"0.05em",marginBottom:12}}>{filtered.length} transactions</div>
              {filtered.length===0&&<div style={{color:C.dim,fontSize:13}}>No transactions — tap a day on the calendar to add one.</div>}
              {filtered.map(t=>(
                <div key={t.id} style={{borderBottom:`1px solid ${C.border}`,paddingBottom:8,marginBottom:8}}>
                  {editId===t.id?(
                    <div style={{background:C.high,borderRadius:8,padding:12}}>
                      <div style={{display:"grid",gridTemplateColumns:"2fr 1fr",gap:8,marginBottom:8}}>
                        <div><span style={lbl}>Description</span><input value={editDesc} onChange={e=>setEditDesc(e.target.value)} style={inp}/></div>
                        <div><span style={lbl}>Amount</span><input type="number" value={editAmt} onChange={e=>setEditAmt(e.target.value)} style={inp}/></div>
                      </div>
                      {t.type!=="transfer"&&<div style={{marginBottom:8}}><span style={lbl}>Category</span>
                        <select value={editCat} onChange={e=>setEditCat(e.target.value)} style={inp}>
                          {CATS[t.type].map(c=><option key={c}>{c}</option>)}
                        </select>
                      </div>}
                      {t.type!=="income"&&<div style={{marginBottom:8}}><span style={lbl}>From account</span>
                        <select value={editFrom} onChange={e=>setEditFrom(e.target.value)} style={inp}>
                          {ACCOUNTS.map(a=><option key={a}>{a}</option>)}
                        </select>
                      </div>}
                      {t.type!=="expense"&&<div style={{marginBottom:8}}><span style={lbl}>To account</span>
                        <select value={editTo} onChange={e=>setEditTo(e.target.value)} style={inp}>
                          {ACCOUNTS.map(a=><option key={a}>{a}</option>)}
                        </select>
                      </div>}
                    ...
                    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                      <div style={{display:"flex",alignItems:"center",gap:10}}>
                        ...
                        <div>
                          ...
                          <div style={{color:C.dim,fontSize:11}}>{t.category} · {t.type==="income"?`→ ${t.toAccount}`:t.type==="expense"?t.fromAccount:`${t.fromAccount} → ${t.toAccount}`} · {t.date}</div>
                        </div>
                      </div>
                      <div style={{display:"flex",alignItems:"center",gap:8}}>
        ...
        {mainTab==="career"&&(
          <div>
              ...
              <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(115px,1fr))",gap:8}}>
                {WEEKLY_PLAN.map((w,i)=>(
                  <div key={i} style={{background:C.high,borderRadius:10,padding:"10px 12px",borderTop:`3px solid ${w.color}`}}>
                    ...
                    {w.links.length>0&&<div style={{marginTop:8,borderTop:`1px solid ${C.border}`,paddingTop:6}}>
            ...
            <div style={{background:C.surface,border:`1px solid ${C.amber}`,borderRadius:12,padding:16}}>
              ...
              {[
                {date:"Aug 2026",event:"New grad apps open — start applying even if unprepared",color:C.red},
